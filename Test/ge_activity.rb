...
class TC_Activity < Test::Unit::TestCase
  ...
  def test_add_payment
    ...
    assert_equal [@library, @internet], Activities.active_for( @student_1, d )
    assert_equal [@internet], Activities.active_for( @student_2, d )
    assert_equal [], Activities.active_for(@student_2, d.yesterday)
