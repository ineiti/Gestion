Gem::Specification.new do |s|
  ...
  s.add_dependency 'qooxview', '1.9.12'
  s.add_dependency 'africompta', '1.9.12'
  s.add_dependency 'network', '1.9.12'
  s.add_dependency 'helper_classes', '1.9.12'
  s.add_dependency 'hilink_modem', '1.9.12'
  s.add_dependency 'serial_modem', '1.9.12'
